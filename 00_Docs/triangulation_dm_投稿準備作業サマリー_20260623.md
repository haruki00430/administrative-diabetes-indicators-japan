# NDB_XXX_triangulation_dm 投稿準備作業サマリー
...
| Data availability | MHLW NDB URL + **GitHub**（https://github.com/haruki00430/NDB_XXX_triangulation_dm） |
...
| `04_Manuscripts/Manuscript_triangulation_dm.qmd` | 旧Quarto草稿（Data availabilityにGitHubプレースホルダ残存） |
...
| GitHub / Zenodo | **GitHub 公開済み** | https://github.com/haruki00430/NDB_XXX_triangulation_dm ；Zenodo は任意 |
| `Manuscript_triangulation_dm.qmd` 同期 | 任意 | 再レンダリング時にプレースホルダ残存に注意 |
...
.venv\Scripts\python.exe projects\NDB_XXX_triangulation_dm\03_Analysis\scripts\06_task_E_denominator_sensitivity.py
```
